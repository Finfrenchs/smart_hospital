...
class _CreatePageState extends State<CreatePage> {
  ...
  TextEditingController _tglBookCont = TextEditingController();
  List<String> polis = ["Poli Umum", "Poli Anak", "Poli Gigi", "Poli Saraf"];

  // @override
  // void initState() async {
  //   super.initState();
  //   //dokters = await fetchDokter() as Future<List<Dokter>>?;
  //   dokters = await fetchDokter();
  // }
